    ...
    <el-card id="search">
      <el-row><!--24分-->
        <el-col :span="20">
          ...
          <el-button @click='getUserList' type="primary" round icon="el-icon-search">查询</el-button></el-col>
        <el-col :span="4" align="right">
          <el-button @click="openEditUI(null)" type="primary" icon="el-icon-plus" circle></el-button></el-col>
      </el-row>
    </el-card>
...
export default {
  ...
  methods: {
    ...
    deleteUser(user) {
      this.$confirm(`您确认删除用户${user.username}?`, '此操作将永久删除该文件, 是否继续?', '提示', {
